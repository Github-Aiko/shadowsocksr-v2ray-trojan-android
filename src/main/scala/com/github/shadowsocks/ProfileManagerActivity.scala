...
//      }
    ...
    case R.id.action_import_file =>
      ...
      intent.addCategory(Intent.CATEGORY_OPENABLE)
      startActivityForResult(Intent.createChooser(intent, "AikoR"), REQUEST_IMPORT_PROFILES)
      true
    case R.id.action_import_qrcode_image =>
      ...
      intent.putExtra(Intent.EXTRA_LOCAL_ONLY, true)
      intent.addCategory(Intent.CATEGORY_OPENABLE)
      startActivityForResult(Intent.createChooser(intent, "AikoR"), REQUEST_IMPORT_QRCODE_IMAGE)
      true
